...
# INITIALIZE SYSTEM AND SIMULATION PARAMETERS:
    ...
    SIM_TIME      = 115                     # Simulation time duration (s)
#--------------------------------------------------------------------------------
    ...
    while not rospy.is_shutdown():
        ...
        if runtime > 15 and runtime <=20:
            ...
            if runtime == 20:
                ...
                ys = uav.local_pos.y
                j  = 0
                yr = np.linspace(ys,-1.65,num=(5.0/dt))
        ...
        if runtime > 35 and runtime <=95:
            xref = -0.9
            yref = -1.65
            zref = 1.3 + trajectory.sinusoid(0.27,dt,15)
        ...
        # Go to Y=1.0
        if runtime > 100 and runtime <=105:
            xref = -0.9
            yref = yr[j]
            zref = 1.0
            j   += 1
