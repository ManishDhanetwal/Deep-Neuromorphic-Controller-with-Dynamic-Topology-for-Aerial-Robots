...
# INITIALIZE SYSTEM AND SIMULATION PARAMETERS:
    ...
    PID_GAIN_Z    = [2.5,0.0,0.0]         # PID Gain Parameter [KP,KI,KD] axis-Z KP=0.85
...
# ROS Main loop::
    ...
    while not rospy.is_shutdown():
        ...
        if runtime <= 30:
            xref = 0.0
            yref = 0.0
            zref = 0.3+trajectory.linear(0.7,dt,20)
        ...
        # vz = PID_GAIN_Z[0]*errz+PID_GAIN_Z[1]*interrz+PID_GAIN_Z[2]*derrz
