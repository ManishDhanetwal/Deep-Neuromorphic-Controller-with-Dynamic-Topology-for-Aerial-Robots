...
# INITIALIZE ADAPTIVE NETWORK PARAMETERS:
    ...
    LEARNING_RATE_X = 0.01             # Network optimization learning rate 0.00085
    LEARNING_RATE_Y = 0.01             # Network optimization learning rate 0.00085
    LEARNING_RATE_Z = 0.02             # Network optimization learning rate
...
# INITIALIZE SYSTEM AND SIMULATION PARAMETERS:
    ...
    PID_GAIN_Z    = [0.75,0.0,0.0001]         # PID Gain Parameter [KP,KI,KD] axis-Z
...
# ROS Main loop::
    ...
    while not rospy.is_shutdown():
        ...
        if runtime > 15 and runtime <= 35:
            xref = trajectory.linear(1.8,dt,20)
            yref = -1.0
            zref = 1.5
        ...
        print Zcon.netStruct[0].linear.weight.data
        print Zcon.netStruct[1].linear.weight.data
        print
