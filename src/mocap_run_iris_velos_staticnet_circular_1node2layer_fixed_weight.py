...
# Ignite the Evolving NN Controller
    ...
    Wx0=torch.tensor([[ 0.5635,  0.5616,  0.5580, -0.0346]], dtype=torch.float64,requires_grad = True)
    Wx1=torch.tensor([[1.0270]], dtype=torch.float64,requires_grad = True)
    # Wx2=torch.tensor([[0.3805, 0.5764, 0.6651]], dtype=torch.float64,requires_grad = True)

    Wy0=torch.tensor([[-0.6251, -0.6237, -0.6169, -0.0040]], dtype=torch.float64,requires_grad = True)
    Wy1=torch.tensor([[-1.1246]], dtype=torch.float64,requires_grad = True)

    Wz0=torch.tensor([[ 0.3981,  0.3878,  0.3769, -0.0762]], dtype=torch.float64,requires_grad = True)
    Wz1=torch.tensor([[0.6534]], dtype=torch.float64,requires_grad = True)
