...
# INITIALIZE ADAPTIVE NETWORK PARAMETERS:
    ...
    LEARNING_RATE_Z = 0.075               # Network optimization learning rate
...
# INITIALIZE SYSTEM AND SIMULATION PARAMETERS:
    ...
    SIM_TIME      = 205                     # Simulation time duration (s)
#--------------------------------------------------------------------------------
...
# ROS Main loop::
    ...
    while not rospy.is_shutdown():
        ...
        # Learning Sinusoidal Z trajectory after 10 times = 150 s 
        ...
        # Go to Y=1.0
        if runtime > 190 and runtime <=195:
            xref = -0.9
            yref = yr[j]
            zref = 1.0
            j   += 1
