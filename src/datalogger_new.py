...
class dataLogger(object):
        ...
        def __init__(self,logType):
            ...
            if logType == 'flight':
                self.logFile = open("FlightStateLog"+self.timestr+".txt", "w+")
            else:
                self.logFile = open(logType+"-ControlLog"+self.timestr+".txt", "w+")
...
def saveParameters(runType,netX,netY,netZ):
    ...
    logW = open(runType+"_Weights"+time.strftime("%Y%m%d-%H%M%S")+".txt", "w+")
